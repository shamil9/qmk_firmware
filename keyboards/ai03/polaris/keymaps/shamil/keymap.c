...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all( /* Base */
    ...
    KC_LALT,        KC_LGUI, KC_LGUI,           KC_SPC,           LT(1, KC_SPACE),         KC_SPC,                     OSL(1),  KC_RGUI, KC_APP,  KC_HYPR
  ),
  ...
  KC_TRNS,          KC_TRNS,  KC_TRNS, CONE,    KC_TRNS, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, LARW,     RARW,    RARWF,            KC_TRNS, RESET,
  ...
  [2] = LAYOUT_all( /* Base */
    ...
    KC_LGUI,        KC_LGUI, KC_LALT,           KC_SPC,           KC_SPACE,       KC_SPC,                     OSL(1),  KC_RGUI, KC_APP,  KC_HYPR
  ),
};
