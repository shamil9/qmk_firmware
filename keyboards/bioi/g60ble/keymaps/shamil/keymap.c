...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LSFT,        KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,          KC_M,    KC_COMM, KC_DOT,    KC_SLSH, KC_LSFT, WIN_LAYOUT,
    ...
    [1] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LSFT,        KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,   KC_N,           KC_M,    KC_COMM, KC_DOT,    KC_SLSH, KC_LSFT, MAC_LAYOUT,
