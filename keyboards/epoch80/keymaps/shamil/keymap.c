...
LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,                HYPR_T(KC_ENT),
       ...
       KC_LALT,          KC_LGUI,                   LT(2, KC_SPC),                      KC_RALT,           WIN_LAYOUT,                                      KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,                KC_ENT,
       KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_LSFT,                                                  KC_UP,
       MO(2),            KC_LALT,                   KC_SPC,                             KC_RGUI,           MAC_LAYOUT,                                       KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [2] = LAYOUT_tkl_ansi_wkl(
        KC_TRNS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,                             _______, _______, RGB_TOG,
