...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_PGDN,    LCTL_T(KC_ESC), KC_A,       KC_S,       KC_D,     KC_F,       KC_G,       KC_H,   KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,    KC_ENT, \
                    KC_LSFT,        KC_Z,       KC_X,       KC_C,     KC_V,       KC_B,       KC_B,   KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT, TD(GAMING), \
                    KC_LALT,        KC_LGUI,    LT(1, KC_SPC),                    OSL(1),     KC_SPC,                         OSL(1),                             KC_HYPR \
    ),
    ...
    [2] = LAYOUT(
        ...
        KC_PGDN,    KC_LCTRL,       KC_A,       KC_S,       KC_D,     KC_F,       KC_G,       KC_H,    KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,    KC_ENT, \
                    KC_LSFT,        KC_Z,       KC_X,       KC_C,     KC_V,       KC_B,       KC_B,    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT, TD(DEFAULT), \
                    KC_LGUI,        KC_LALT,    KC_SPC,                           OSL(3),     LT(3, KC_SPC),                        KC_RGUI,                            KC_HYPR \
    ),

    [3] = LAYOUT(
        RGB_TOG,    KC_TRNS,        KC_F1,      KC_F2,      KC_F3,     KC_F4,     KC_F5,      KC_F6,   KC_F7,      KC_F8,      KC_F9,     KC_F10,     KC_F11,     KC_F12,   RGB_HUI, RGB_HUD, \
        RGB_MOD,    KC_TRNS,        KC_UP,      KC_TRNS,    EONE,      ETWO,      ETHREE,     KC_TRNS, UONE,       UTWO,       KC_TRNS,   KC_TRNS,    KC_MPRV,    KC_MNXT,  KC_MUTE, \
        RGB_RMOD,   KC_LEFT,        KC_DOWN,    KC_RGHT,    KC_BSPC,   KC_TRNS,   KC_TRNS,    KC_LEFT, KC_DOWN,    KC_UP,      KC_RGHT,   KC_TRNS,    KC_TRNS,    KC_TRNS, \
                    KC_LSFT,        KC_TRNS,    KC_TRNS,    CONE,      RGB_SAD,   RGB_VAI,    RGB_VAD, KC_TRNS,    KC_TRNS,    LARW,      RARW,       RARWF,      KC_TRNS,  RESET, \
                    KC_TRNS,        KC_LALT,    KC_TRNS,    KC_TRNS,              KC_TRNS,    KC_RALT,                                                     KC_TRNS \
    ),
};
