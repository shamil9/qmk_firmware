...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                   KC_ENT,
		...
		KC_LCTL, KC_LGUI,                   KC_LALT, LT(1, KC_SPACE),  LT(1, KC_SPACE),  KC_RALT,                   KC_RGUI, KC_RCTL, TO(1)
    ),
    ...
    [2] = LAYOUT_split_bs_rshift(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, X(12),   _______, _______, _______, _______, _______, _______, LARW,    RARW,    RARWF,            TD(DEFAULT),
