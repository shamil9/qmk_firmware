...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
      ...
      KC_TRNS,        RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI,   RGB_SAD,    RGB_VAI, RGB_VAD,   KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_TRNS,
      KC_TRNS,        KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS, KC_TRNS,   KC_LEFT,    KC_DOWN, KC_UP,     KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS,
      KC_TRNS,        KC_TRNS, KC_TRNS, BL_DEC,  BL_TOGG, BL_INC,    BL_STEP,    KC_TRNS, LARW,      RARW,    RARWF,   KC_TRNS, RESET,
