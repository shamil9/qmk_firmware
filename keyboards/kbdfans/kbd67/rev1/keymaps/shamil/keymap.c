...
[1] = LAYOUT_all(
        ...
        KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS,   CONE,      KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, LARW,          RARW,     RARWF,    KC_TRNS, KC_VOLU,                RESET,\
...
[2] = LAYOUT_all(
        ...
        KC_CAPS,  KC_LGUI, KC_LALT,       KC_TRNS,       KC_SPACE, KC_TRNS, OSL(1), KC_LALT,  KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT \
),
};
