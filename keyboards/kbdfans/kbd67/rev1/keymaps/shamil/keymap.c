...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [LAYOUT_2]  = ACTION_TAP_DANCE_DUAL_ROLE(KC_MPLY, 2),
...
[0] = LAYOUT_all(
        ...
        LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,      KC_F,      KC_G,    KC_H,            KC_J,    KC_K,     KC_L,         KC_SCLN, TD(ALT_E), KC_ENT,                          KC_PGDOWN,\
        KC_LSPO,        KC_NUBS, KC_Z,    KC_X,      KC_C,      KC_V,    KC_B,            KC_N,    KC_M,     TD(ALT_C),    KC_DOT,  KC_SLASH,  KC_RSPC, KC_UP,                  KC_MPLY,\
        ALL_T(KC_CAPS), KC_LALT, KC_LGUI,            KC_TRNS,            LT(1, KC_SPACE), KC_TRNS, KC_LGUI,  KC_LALT,      KC_TRNS,            KC_LEFT, KC_DOWN, KC_RGHT \
),

[1] = LAYOUT_all(
        KC_TRNS,        KC_F1,   KC_F2,   KC_F3,     KC_F4,     KC_F5,   KC_F6,           KC_F7,   KC_F8,   KC_F9,         KC_F10,   KC_F11,   KC_F12,  KC_TRNS, KC_TRNS,       KC_TRNS,\
        KC_TRNS,        KC_TRNS, KC_TRNS, KC_ENT,    KC_TRNS,   KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,                KC_TRNS,\
        KC_TRNS,        KC_TRNS, KC_TRNS, KC_BSPC,   KC_LBRC,   KC_RBRC, KC_LEFT,         KC_DOWN, KC_UP,   KC_RGHT,       KC_TRNS,  KC_TRNS,  KC_TRNS,                         KC_TRNS,\
        KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS,   KC_TRNS, KC_LCBR,         KC_RCBR, KC_TRNS, LARW,          RARW,     RARWF,    KC_TRNS, KC_VOLU,                RESET,\
