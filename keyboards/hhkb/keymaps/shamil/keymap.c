...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [2] = LAYOUT(
        ...
        KC_LGUI, KC_LALT, /*        */ KC_SPACE,     TT(3),   KC_RGUI),

    [3] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,     KC_4, KC_5, KC_6, KC_7,  KC_8,      KC_9,   KC_0,    KC_MINS,  KC_EQL,  KC_BSLS, KC_GRAVE,
        KC_TAB,  KC_Q,    KC_UP,   KC_E,     KC_R, KC_T, KC_Y, KC_U,  KC_I,      KC_O,   KC_P,    KC_MPRV,  KC_MNXT, KC_BSPC,
        KC_LCTL, KC_LEFT, KC_DOWN, KC_RIGHT, KC_F, KC_G, KC_H, KC_J,  KC_K,      KC_L,   KC_SCLN, KC_QUOTE, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,     KC_V, KC_B, KC_N, KC_M,  KC_COMMA,  KC_DOT, KC_SLSH, KC_RSFT,  TD(DEFAULT),
        KC_LGUI, KC_LALT, /*        */ KC_SPACE,     TO(2),   KC_RGUI),
  };
