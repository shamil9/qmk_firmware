...
// Default layer
[0] = LAYOUT_60_hhkb(
	KC_ESC,         KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    TD(ALT_SIX),    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_DEL,
...
[1] = LAYOUT_60_hhkb(
    ...
    RGB_TOG,       RGB_RMOD, RGB_MOD, EONE,    ETWO,    KC_T,    KC_Y,           UONE,    UTWO,    KC_O,     KC_P,    KC_MPRV, KC_MNXT, KC_BSLS,
